...
def create_task():
    global task_id_control  # para usar a variavel q esta fora para controle
...
def update_task(id):
    ...
    for t in tasks:
        if t.id == id:
            task = t
            break # quebra o loop quando achar pra n ficar percorrendo todos mesmo apos achar 
...
# Rota test de parametro
# Documentação flask.palletsprojects.com/en/3.0.x/quickstart/#routing
